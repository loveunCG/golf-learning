...
// @ignore
// ===================================================================================================
require_once(dirname(__FILE__) . '/base/KalturaClient.php');

class Index implements IKalturaLogger
{
	...
	public function listActions()
	{
		...
		if(isset($entry) && !empty($entry) && count($entry) > 0){
			$sendResult = $entry;
		}else{
			$sendResult = array();
		}
